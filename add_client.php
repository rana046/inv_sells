	        ...
	        <div style="">
				<form method="post" style="height:auto;">
					...
					<div class="form-group" style="margin-top:20px;margin-left:20px;" >
						...
						<th colspan="2" align="center" style="text-align: center;">ADD A NEW CLIENT</th>

						</thead>
						<tbody>
							<tr>
						   <td> <label for="Price">Shop Name</label></td><td><input type="text" class="form-control" id="text" name="shop"  style="box-shadow:0 0 7px;"></td>
						</tr>
						<tr>
...
$query="insert into add_buyers(shop,owner,location,mobile)values('$shop','$owner','$location','$mobile')";
