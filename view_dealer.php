  ...
  <form method="post">
    ...
    <div class="" style="margin-right:20px;" >
       ...
       <table class="table table-responsive table-bordered">
          ...
          <thead style="background:#03C9A9;color:#fff"><th colspan="11" align="center" style="text-align: center;">All Dealer's List</th></thead>
          
          <tbody>
          <tr style="text-align: center;font-family: cursive;">
              <td> <label for="Price">No.</label></td>
              <td> <label for="Price">Company Name</label></td>
              <td> <label for="Price">Owner</label></td>
              <td> <label for="Price">Product Type</label></td>
          ...
          ?>
            ...
            <td> <label for="Price"><?php echo $id;  ?></label></td>
              <td> <label for="Price"><?php echo $org;  ?></label></td>
