  ...
  <form method="post">
    ...
    <div class="" style="margin-right:20px;" >
       ...
       <table class="table table-responsive table-bordered">
          ...
          <thead style="background:#03C9A9;color:#fff"><th colspan="13" align="center" style="text-align: center;">Dealer Stock</th></thead>
          ...
          ?>
            ...
            <td> <label for="Price"><?php echo $id;  ?></label></td>
              <td> <label for="Price"><?php echo $brand;  ?></label></td>
               ...
               <td align="center"><a href="" class="btn btn-info">Update</a> </td> 
            </tr>
           <?php  }  ?> 
